...
public enum AuthCode implements ResultCode {
    ...
    AUTH_ACCOUNT_NOTEXISTS(false,23004,"账号不存在,或者处于封禁状态！"),
    AUTH_CREDENTIAL_ERROR(false,23005,"账号或密码错误！"),
    AUTH_LOGIN_ERROR(false,23006,"登陆过程出现异常请尝试重新操作！"),
    AUTH_LOGIN_APPLYTOKEN_FAIL(false,23007,"请求失败"),
    AUTH_LOGIN_TOKEN_SAVEFAIL(false,23009,"保存失败"),
    AUTH_LOGOUT_FAIL(false,23010,"删除cookie失败，退出失败");
