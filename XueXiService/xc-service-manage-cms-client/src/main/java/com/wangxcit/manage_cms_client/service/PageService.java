package com.wangxcit.manage_cms_client.service;
...
import com.wangxcit.manage_cms_client.dao.CmsPageRepository;
import com.wangxcit.manage_cms_client.dao.CmsSiteRepository;
...
public class PageService {
    ...
    public void savePageToServerPath(String pageId){
        ...
        System.out.println("页面发布后，页面保存路径为"+pagePath);
        //查询页面静态文件
