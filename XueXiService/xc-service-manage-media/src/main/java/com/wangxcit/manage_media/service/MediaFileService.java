...
public class MediaFileService {
    ...
    public QueryResponseResult<MediaFile> findList(int page, int size, QueryMediaFileRequest queryMediaFileRequest) {
        ...
        if(StringUtils.isNotEmpty(queryMediaFileRequest.getUid())){
            mediaFile.setUid(queryMediaFileRequest.getUid());
        }
...
//                                        .withMatcher("processStatus",ExampleMatcher.GenericPropertyMatchers.exact());//如果不设置匹配器默认精确匹配
        ...
        /*Page<MediaFile> all = mediaFileRepository.findAll(pageable);*/
        //总记录数
